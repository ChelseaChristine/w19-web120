...
#EDIT THE FOLLOWING:
$toAddress = "chelsea.jansen@seattlecolleges.edu";  //place your/your client's email address here
$toName = "Charolette Richardson"; //place your client's name here
$website = "Charolette Jae";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
...
if ($response != null && $response->success)
    ...
    <div class="contact-feedback">
        ...
        <p>I will try to respond if need be as soon as possible! </p>
    </div>    
    <!-- END HTML FEEDBACK -->        
    <?php
